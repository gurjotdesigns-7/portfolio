        ...
        <div className="hs-left">
          ...
          <Reveal delay={150}>
            <p className="hs-sub">
              ...
              <span className="muted">working across Moj, FriendZone, and Vibely.</span>
              <br /><br />
              <strong>4+ years</strong>{' '}
              <span className="muted">designing for</span>{' '}
              <strong>growth, retention, and creator monetisation.</strong>{' '}
              <span className="muted">Background in</span>{' '}
              <strong>architecture,</strong>{' '}
              <span className="muted">obsessed with how structure shapes behaviour.</span>
            </p>
          </Reveal>
    ...
    <div className="page home-page">
      ...
      <section id="work" className="case-studies-section">
        ...
        <div className="container case-studies-container">
          ...
          <a href="https://www.figma.com/proto/8axG8i1fABBuCeFsUY2eh2/Case-Studies?page-id=13%3A27480&node-id=702-19958&viewport=4270%2C-2635%2C0.38&t=qPOdin1e9WOOMAGx-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=392%3A24762" target="_blank" rel="noopener noreferrer" className="cs-row-link">
