    ...
    <div className="page home-page">
      ...
      <section className="award-section" aria-label="Award">
        <div className="award-paper">
          ...
          <div className="award-inner">
            ...
            <div className="award-text">
              ...
              <p className="award-body">
                ...
                product that reaches donors when no bank nearby has the blood.
              </p>
              <a
                className="award-cta"
          ...
          {/* The case, in four numbers — the deck's core argument */}
          <div className="award-stats" aria-label="The case, in four numbers">
            <div className="award-stat">
              <span className="award-stat-num">3.47<span className="award-stat-unit"> lakh</span></span>
              <span className="award-stat-label">searches a month on UMANG’s blood-availability service</span>
            </div>
            <div className="award-stat">
              <span className="award-stat-num">28<span className="award-stat-unit"> lakh</span></span>
              <span className="award-stat-label">donors on e-RaktKosh — unreachable by any citizen</span>
            </div>
            <div className="award-stat">
              <span className="award-stat-num">~10<span className="award-stat-unit">%</span></span>
              <span className="award-stat-label">of districts still have no blood centre at all</span>
            </div>
            <div className="award-stat">
              <span className="award-stat-num">0</span>
              <span className="award-stat-label">next steps today when nothing is nearby — the journey just ends</span>
            </div>
          </div>
        ...
        <Reveal delay={200}>
          <div className="footer-row">
            <div className="footer-socials">
              ...
              <a href="https://drive.google.com/file/d/1VwLeYBXDpByv5wpLtAVIgLy3ILwCosKl/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Download Resume">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
